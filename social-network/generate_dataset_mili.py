...
def generate_graphs(input_graph_dir, input_dir, output_dir, output_valid_dir, rejection_threshold):
    ...
    for filename in os.listdir(input_dir):
            ...
            for line in file:
                ...
                if reached_micro_stats:
                    ...
                    if not re.search(r'\d', line_data[0]):
                        ...
                        micro_avg_rt[line_data[0]] = float(line_data[3])
                        micro_p95_rt[line_data[0]] = float(line_data[7])
                        micro_p99_rt[line_data[0]] = float(line_data[8])
        ...
        latency_1_3 = conf_map["latencyedgefog"]
